# get_Antidepressant_Treatment_Timeline(): Builds consecutive treatment instance and
# period tables for antidepressants and antipsychotics.
#
# Arguments:
...
get_Antidepressant_Treatment_Timeline <- function(
  ...
  return(
    list(
      antidepressant_antipsychotic_consecutive_instance = consecutive_instance_tab,
      antidepressant_antipsychotic_consecutive_period   = consecutive_period_tab
    )
  )
}
