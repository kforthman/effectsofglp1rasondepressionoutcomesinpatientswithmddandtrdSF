...
get_TRD <- function(
  ...
  TRD_list_df <- data.frame(PatientDurableKey = unique(TRD_list$PatientDurableKey))
  
  return(
    list(
      consecutive_instance_tab      = consecutive_instance_tab,
      consecutive_period_tab        = consecutive_period_tab,
      consecutive_period_tab_summ   = consecutive_period_tab_summ,
      consecutive_period_maxDrugs   = consecutive_period_maxDrugs,
      TRD_list_df                   = TRD_list_df
    )
  )
}
